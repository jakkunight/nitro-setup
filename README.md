...
The only project tha is "well mantained" is [My Setup Settings](https://github.com/jakkunight/my-setup-settings) 
...
cannot obtain without moving to unstable distros and allways risking 
all my job.

This days, a "new" distro has appeared on the stage: NixOS.
NixOS is a complete diffrerent Linux distro. Built on the top of th Nix 
...
be familiar with th Nix programming language, a strange mix between 
...
Now that I belive that I've a better knowladge about what's going on, it's
